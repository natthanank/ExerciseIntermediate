...
public class TestRouteActivity extends AppCompatActivity {
    ...
    private static final String TAG = TestRouteActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Viewpoint sanDiegoPoint = new Viewpoint(32.7157, -115.1611, 200000);
                    ...
                    public void run() {
                        try {
                            if (listenableFuture.isDone()) {
                                ...
                                // create stops
                                Stop stop1 = new Stop(new Point(-115.15083257944445, 32.741123367963446, SpatialReferences.getWgs84()));
                                Stop stop2 = new Stop(new Point(-115.15557279683529, 32.703360305883045, SpatialReferences.getWgs84()));
        ...
        try {
            ...
            pinSourceSymbol.addDoneLoadingListener(new Runnable() {
                ...
                public void run() {
                    ...
                    mSourcePoint = new Point(-115.15083257944445, 32.741123367963446, SpatialReferences.getWgs84());
        ...
        try {
            ...
            pinDestinationSymbol.addDoneLoadingListener(new Runnable() {
                ...
                public void run() {
                    ...
                    mDestinationPoint = new Point(-115.15557279683529, 32.703360305883045, SpatialReferences.getWgs84());
